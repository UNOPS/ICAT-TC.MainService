...
export const fileLocation = (req, file, callback) => {
    let dir = join(statticFileLocation, 'Methodology Assessment documents');
...
export const editFileNameForStorage = (file) => {
  ...
  export const fileLocationForStorage = () => {
    return join(statticFileLocation, 'Methodology Assessment documents');
  };