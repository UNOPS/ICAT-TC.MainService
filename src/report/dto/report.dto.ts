...
export class ReportCarbonMarketDto {
  reportName: string = '';
  coverPage: ReportCarbonMarketDtoCoverPage =
    new ReportCarbonMarketDtoCoverPage();
  tableOfContent: ReportCarbonMarketDtoTableOfContent =
    new ReportCarbonMarketDtoTableOfContent();
  contentOne: ReportCarbonMarketDtoContentOne =
    new ReportCarbonMarketDtoContentOne();
  contentTwo: ReportCarbonMarketDtoContentTwo =
    new ReportCarbonMarketDtoContentTwo();
  contentThree: ReportCarbonMarketDtoContentThree =
    new ReportCarbonMarketDtoContentThree();
  contentFour: ReportCarbonMarketDtoContentFour =
    new ReportCarbonMarketDtoContentFour();
  contentFive: ReportCarbonMarketDtoContentFive =
    new ReportCarbonMarketDtoContentFive();
}
...
export class ReportCarbonMarketDtoContentOne {
  ...
  assessment: object[] = [
    { information: 'teat1', description: 'test11' },
    { information: 'teat2', description: 'test22' },
  ];
  barriers: object[] = [
    {
      barrier: 'aaa',
...
export class ReportCarbonMarketDtoContentTwo {
  ...
  prevention_ghg_emissions: object[] = [
    { question: 'test1', answer: 'teat2', comment: 'teat2', document: 'teat3' },
  ];
  prevention_negative_environmental: object[] = [
    { question: 'test1', answer: 'teat2', comment: 'teat2', document: 'teat3' },
  ];
  outcomes: object[] = [
    { preocndition: 'teat', outcome: 'teats', evidence_provided: 'test' },
  ];
}
...
export class ComparisonReportDto {
  reportName: string = '';
  coverPage: ComparisonReportReportCoverPage =
    new ComparisonReportReportCoverPage();
  tableOfContent: ComparisonReportReportTableOfContent =
    new ComparisonReportReportTableOfContent();
  contentOne: ComparisonReportReportContentOne =
    new ComparisonReportReportContentOne();
  contentTwo: ComparisonReportReportContentTwo =
    new ComparisonReportReportContentTwo();
  contentThree: ComparisonReportReportContentThree =
    new ComparisonReportReportContentThree();
  contentFour: ComparisonReportReportContentFour =
    new ComparisonReportReportContentFour();
  contentFive: ComparisonReportReportContentFive =
    new ComparisonReportReportContentFive();
  contentSix: ComparisonReportReportContentSix =
    new ComparisonReportReportContentSix();
}
...
export class ComparisonReportReportContentFour {
  alignment_heat_map: { sdg_names: string[]; data: object[] } = {
    sdg_names: [],
    data: [],
  };
...
export class ComparisonReportReportContentFive {
  scores: { processScore: number; outcomeScore: number }[] = [];
}
