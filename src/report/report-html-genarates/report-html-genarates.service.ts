  ...
  async reportHtmlGenarate(repportDto: ReportDto): Promise<any> {
    ...
    return {
      content: `<!DOCTYPE html>
        ...
        <link rel="stylesheet" href="${ process.env.MAIN_SERVER_URL}/report/css/reportserverlandscapewithoutpage.css">
            </head>
...
let comparisonContentSix=this.reportPagesService.comparisonContentSix('','',repportDto.contentSix)
  ...
  async assessmentHtmlGenarate(assessmentDto: AssessmentDto): Promise<any> {
    ...
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
    <link rel="stylesheet" href="${ process.env.MAIN_SERVER_URL}/report/css/reportserver.css">
        </head>
