...
export const questions = [
    ...
    {
        label: "Q1: Does the implementation of the carbon market intervention result in significant negative environmental impacts (e.g. air, water and soil pollution, destruction of biodiversity)? “Significant” means a material change of more than 5% of the baseline value of pollution load or biodiversity parameters in the intervention area.",
        code: "S-2-C-3-Q-1",
        answer_type: AnswerType.SINGLE,
        order: 1,
...
export const answers = [
    ...
    {
        label: "Less than a quarter of the technical lifetime",
