...
export const questions = [
    ...
    {
        label: 'Is the Article 6 activity financially additional?',
        code: 'S-2-C-1-Q-2',
        answer_type: AnswerType.SINGLE,
        order: 2,
        criteria: 'S-2-CRITERIA-1'
    ...
    {
        label: 'Does the envisaged Article 6 activity occur entirely outside the scope of the country’s NDC, meaning both its conditional and unconditional NDC targets? ',
        code: 'S-2-C-1-Q-3',
        answer_type: AnswerType.SINGLE,
        order: 3,
        criteria: 'S-2-CRITERIA-1'
    ...
    {
        label: 'Does the envisaged Article 6 activity involve emission reductions or removals that are not included in the GHG inventory used to assess unconditional NDC progress?',
        code: 'S-2-C-1-Q-4',
        answer_type: AnswerType.SINGLE,
        order: 4,
        criteria: 'S-2-CRITERIA-1'
    ...
    {
        label: 'Does the envisaged Article 6 activity contribute to increased ambition by going beyond the host country’s unconditional NDC target(s), contributing to the conditional NDC target? ',
        code: 'S-2-C-1-Q-5',
        answer_type: AnswerType.SINGLE,
        order: 5,
        criteria: 'S-2-CRITERIA-1'
    ...
    {
        label: 'Does the Article 6 activity feature on the host country’s positive list or has the host country stated its intention to promote the envisaged activity type?',
        code: 'S-2-C-1-Q-6',
        answer_type: AnswerType.SINGLE,
        order: 6,
        criteria: 'S-2-CRITERIA-1'
    ...
    {
        label: 'Is the activity listed on any negative list adopted by the host country? ',
        code: 'S-2-C-2-Q-1',
        answer_type: AnswerType.SINGLE,
        order: 1,
    ...
    {
        label: 'Is the activity in line with the host country’s scenarios of its long-term low-emission development strategy (LT-LEDS) (if available), or in case an LT-LEDS is not available, can it be ensured that the activity does not lead to a lock-in of current emission levels or continuation of emissions intensive practices by prolonging the lifetime of installations using emissions technologies or by constructing new installations using emissions intensive technologies? ',
        code: 'S-2-C-2-Q-2',
        answer_type: AnswerType.SINGLE,
        order: 2,
        criteria: 'S-2-CRITERIA-2'
    ...
    {
        label: 'Does the implementation of the Article 6 activity result in any negative environmental impacts (i.e., release of pollutants or unmanaged waste, increased GHG emissions, introduction of genetically modified organisms, etc.)?  ',
        code: 'S-2-C-3-Q-1',
        answer_type: AnswerType.SINGLE,
        order: 1,
    ...
    {
        label: 'Does the implementation of the Article 6 activity result in any negative social impacts (i.e. displacement, forced evictions, violation of rights of indigenous people and local communities, damage or alteration of cultural heritage sites, etc.)? ',
        code: 'S-2-C-3-Q-2',
        answer_type: AnswerType.SINGLE,
        order: 2,
        criteria: 'S-2-CRITERIA-3'
    ...
    {
        label: 'Does the activity design encourage market penetration / replicability of the envisaged mitigation activity, e.g., by implementing a programme across multiple geographies? ',
        code: 'S-3-C-1-Q-1',
        answer_type: AnswerType.SINGLE,
        order: 1,
    ...
    {
        label: 'Does the activity foresee the implementation of upscaled approaches, either through a programmatic or sectoral approach or implementation of a policy? ',
        code: 'S-3-C-1-Q-2',
        answer_type: AnswerType.SINGLE,
        order: 2,
        criteria: 'S-3-CRITERIA-1'
    ...
    {
        label: 'Does the activity make use of smart MRV solutions with the purpose of fostering a more rapid adoption of the mitigation practice/technology due to streamlined or digitalised MRV processes? ',
        code: 'S-3-C-1-Q-3',
        answer_type: AnswerType.SINGLE,
        order: 3,
        criteria: 'S-3-CRITERIA-1'
    ...
    {
        label: 'Does the activity contribute significantly to a specific SDG (apart from SDG13 – Climate Action)? ',
        code: 'S-3-C-2-Q-1',
        answer_type: AnswerType.SINGLE,
        order: 1,
    ...
    {
        label: 'Does the activity result in its inclusion in the unconditional NDC during the next NDC revision?  ',
        code: 'S-3-C-3-Q-1',
        answer_type: AnswerType.SINGLE,
        order: 1,
    ...
    {
        label: 'Does the activity foresee the retainment by the host country of an additional share of mitigation outcomes generated by the activity? ',
        code: 'S-3-C-3-Q-2',
        answer_type: AnswerType.SINGLE,
        order: 2,
        criteria: 'S-3-CRITERIA-3'
    ...
    {
        label: 'Does the activity contribute to increased ambition by limiting the crediting period below the technical lifetime of a project and counting any mitigation that occurs after the crediting period towards national targets? ',
        code: 'S-3-C-3-Q-3',
        answer_type: AnswerType.SINGLE,
        order: 3,
        criteria: 'S-3-CRITERIA-3'
    ...
    {
        label: 'Is the activity innovative, i.e. supports the adoption of newly emerging technologies?  ',
        code: 'S-3-C-4-Q-1',
        answer_type: AnswerType.SINGLE,
        order: 1,
    ...
    {
        label: 'Is the activity’s baseline emission intensity reduced over time to align with the long-term temperature goal of the Paris Agreement? ',
        code: 'S-3-C-5-Q-2',
        answer_type: AnswerType.SINGLE,
        order: 2,
        criteria: 'S-3-CRITERIA-5'
